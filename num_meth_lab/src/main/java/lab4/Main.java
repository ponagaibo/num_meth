...
*/
        ...
        l4.lab4_2_df(boundary_h, boundary_a, boundary_b, y_a, y_b, p_x, q_x, f_x, boundary_real);
...
//        Function<Double, Double> sm_real = (x) -> x + Math.exp(-2. * x);
        ...
        l4.lab4_2_sm(sm_h, sm_a, sm_b, y_a, y_b, sm_func1, sm_func2, sm_real);
*/
